---
title: "Spatial Data Science with R. Day 1."
...
* `raster` is scalable, and has a large functionality
* `raster` data model: single raster layers, or a stack of raster layers, possibly time-referenced.
...
The concept of a _function_ is largely absent in GIS or data base representations, and neither is that of aggregations